  ...
  while (true)
  {
    ...
    case 1:
      ...
      for (;;)
      {
        ...
        if (n == 0)
          break;
        graph::addVertex(t1, g);
        graph::addVertex(t2, g);
        graph::addEdge(t1, t2, n, g);
      }
      break;
    ...
    */
    ...
    case 8:
      ...
      cin >> t1;
      if (graph::nodeDegree(t1, degree, g))
    ...
    case 10:
      ...
      cin >> t1;
      adjlst = graph::adjacentList(t1, g);
    ...
    case 11:
      ...
      cin >> t2;
      graph::findPath(t1, t2, path, len, g);
      if (len == 0)
        cout << "Nessun cammino trovato tra " << t1 << " e " << t2 << endl;
      else
      {
